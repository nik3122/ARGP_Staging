...
bool UInventoryComponent::AddInventoryItem(URPGItem* NewItem, int32 ItemCount, int32 ItemLevel, bool bAutoSlot)
{
	bool bChanged = false;
	if (!NewItem)
	{
...
bool UInventoryComponent::RemoveInventoryItem(URPGItem* RemovedItem, int32 RemoveCount)
{
	if (!RemovedItem)
	{
		return false;
...
bool UInventoryComponent::SetSlottedItem(FRPGItemSlot ItemSlot, URPGItem* Item)
{
...
int32 UInventoryComponent::GetInventoryItemCount(URPGItem* Item) const
{
...
bool UInventoryComponent::GetInventoryItemData(URPGItem* Item, FRPGItemData& ItemData) const
{
	const FRPGItemData* FoundItem = InventoryData.Find(Item);
...
URPGItem* UInventoryComponent::GetSlottedItem(FRPGItemSlot ItemSlot) const
{
...
bool UInventoryComponent::FillEmptySlotWithItem(URPGItem* NewItem)
{
