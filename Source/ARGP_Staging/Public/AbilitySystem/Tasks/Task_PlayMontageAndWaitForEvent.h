...
UCLASS()
class ARGP_STAGING_API UTask_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UTask_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	UFUNCTION(BlueprintCallable, Category = "Ability|Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
		static UTask_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
